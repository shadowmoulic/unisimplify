...
import { User, BookOpen, GraduationCap, FileText, Settings, ChevronRight, ChevronLeft, CheckCircle2, Sparkles, ShieldCheck } from 'lucide-react';
...
export default function Onboarding() {
  ...
  const [formData, setFormData] = useState({
    ...
    school10: '', board10: '', percentage10: '',
    school12: '', board12: '', percentage12: '',
    jeeScore: '', neetScore: '', cuetScore: '',
    preferredCourse: '', preferredState: '', budget: ''
  });
              ...
              <div className="form-section">
                ...
                <div className="input-grid">
                  ...
                  <div className="input-group">
                    ...
                    <input type="text" name="percentage10" placeholder="e.g. 95% or 9.5" value={formData.percentage10} onChange={handleChange} />
                  </div>
                </div>
              </div>
            )}
